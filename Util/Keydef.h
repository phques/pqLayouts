...
public:
    ...
    KeyValue(Commands cmd, bool shift = false, bool control = false, bool alt = false);
    ...
    KeyValue& Cmd(Commands v) { cmd = v; return *this; }
...
private:
    ...
    bool control{};
    bool alt{};
    Commands cmd{}; // e.g.'#SelectWord' # => cmd
};
